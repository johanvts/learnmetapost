...
It is written as a step-by-step tutorial meant to be read from beginning to end, to get started go to [[https://learnmetapost.onrender.com/learn-metapost/][Getting Started]].
...
reference see the excellent [[https://www.tug.org/docs/metapost/mpman.pdf][MetaPost Manual]]. The course was written by [[https://www.johansivertsen.com][me]], if you have feedback or suggestion please use the
