...
The build-in equation solver is very usefull for drawing figures of mathematical concepts without having to assign absolute positions.
...
Now lets say we wanted to draw a horisontal line from the point of intersection.
